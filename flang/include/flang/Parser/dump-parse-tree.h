...
#include "llvm/Frontend/OpenACC/ACC.inc"
  ...
  NODE(parser, FnACCPackClause)
  NODE(FnACCPackClause, Item)
  NODE_NAME(FnACCPackTarget, "FnACCPackTarget")
  ...
  NODE(parser, FnACCExitDataClause)
  NODE(parser, FnACCCopyinClause)
  NODE(parser, FnACCCreateClause)
  NODE(parser, FnACCCopyoutClause)
  NODE(parser, FnACCDeleteClause)
  ...
  NODE(OmpAdjustArgsClause, Modifier)
  NODE(parser, OmpAdjustOp)
  NODE_ENUM(OmpAdjustOp, Value)
