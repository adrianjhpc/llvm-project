...
subroutine matmul_bounds_f32(ilo,ihi,jlo,jhi,klo,khi,al,au,bl,bu,cl,cu,a,b,c)
  integer :: ilo,ihi,jlo,jhi,klo,khi,al(2),au(2),bl(2),bu(2),cl(2),cu(2)
  real(4) :: a(al(1):au(1),al(2):au(2))
  real(4) :: b(bl(1):bu(1),bl(2):bu(2))
  real(4) :: c(cl(1):cu(1),cl(2):cu(2)), acc
  integer :: i,j,p
...
! DEVICE: %c_ptrs = tt.addptr %c_base, %c_offsets : tensor<16x16x!tt.ptr<f32>>, tensor<16x16xi64>
! DEVICE: tt.store
! JSON: "kind": "matmul2d"
