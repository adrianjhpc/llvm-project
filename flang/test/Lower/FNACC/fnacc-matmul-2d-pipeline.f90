...
! RUN: fir-opt --fnacc-pipeline="launch-abi=2 ttir-output=%t.ttir json-output=%t.json" %t.fir -o %t.host.fir
...
! TTIR: scf.for
! TTIR: %a_zero = tt.splat %zero : f32 -> tensor<16x32xf32>
! TTIR: %b_zero = tt.splat %zero : f32 -> tensor<32x16xf32>
